        ...
        for(i = 0; i < data.length; i++){
          ...
          $('#movie-table').append(
          	"<tr id = 'movie-id-" + returnedList[i].Id + "'>" +
          		"<td>"      + returnedList[i].Title +
          		"</td><td>" + returnedList[i].Genre + 
          		"</td><td>" + returnedList[i].DirectorName + 
          		"</td><td><a href='#' onclick='getMovieList()'>" +
          		"<button class='btn-small'>Update Entry</button></a>" +
          		"</td></tr>");
        }
      })
    },
